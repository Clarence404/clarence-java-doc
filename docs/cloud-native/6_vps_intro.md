...
> 搬瓦工官方出品的托管 Shadowsocks 服务，底层直接跑在 CN2 GIA / CN2 GT 线路上，**买即可用，不需要自己搭建任何服务**。
...
- **线路**：CN2 GIA（高端套餐）/ CN2 GT（入门套餐）
- **特点**：与搬瓦工同班底，线路质量有保障；支持多设备同时使用；流量超限自动限速而非断线
- **价格**：约 $2.88/月（500G 流量，CN2 GT）~ $9.88/月（1T 流量，CN2 GIA）
- **适合**：不想折腾自建、直接买即用的用户

::: tip 与自建 VPS 的区别
| | Just My Socks | 自建 VPS |
|---|---|---|
| 上手难度 | ✅ 零配置 | ❌ 需要部署服务 |
| 灵活性 | 仅代理 | 可做任何用途 |
| 价格 | 固定套餐 | 按需选配 |
| 线路质量 | CN2 GIA/GT | 取决于选的商家 |
:::
...
| 维度 | 搬瓦工 CN2 GIA | DMIT | CubeCloud | HostDare | Just My Socks |
|---|---|---|---|---|---|
| 类型 | 自建 VPS | 自建 VPS | 自建 VPS | 自建 VPS | ✅ 开箱即用 |
| 线路质量 | 极优 | 极优（三网） | 优 | 良 | 极优（CN2 GIA/GT） |
| 香港节点 | ✅ 有（贵） | ✅ 三网直连 | ✅ 三网优化 | ❌ 无 | ❌ 无 |
| 洛杉矶节点 | ✅ CN2 GIA | ✅ CN2 GIA+CMI | ✅ 有 | ✅ CN2 GIA | ✅ CN2 GIA/GT |
| 支持支付宝 | ❌ | ❌ | ✅ | ❌ | ❌ |
| 中文支持 | 一般 | 一般 | ✅ 好 | 一般 | 一般 |
| 价格 | 贵 | 贵 | 中等 | 便宜 | 中等（按流量套餐） |
| 需要自建 | ✅ 需要 | ✅ 需要 | ✅ 需要 | ✅ 需要 | ❌ 不需要 |
| 稳定性口碑 | 高 | 高 | 中高 | 中 | 高 |
| 适合场景 | 生产环境 | 极低延迟需求 | 国内用户首选 | 预算受限 | 懒人首选 |
