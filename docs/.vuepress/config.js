...
export default defineUserConfig({
    ...
    theme: defaultTheme({
        ...
        navbar: [  // 顶部导航栏配置
            ...
            {text: '微服务', link: '/micro_service/1_base'},
            {text: '消息队列', link: '/mq/1_mq'},
            {text: '高并发', link: '/high_concurrency/0_concurrent'},
            {text: '分布式', link: '/distributed/0_distributed'},
            {text: '高可用', link: '/high_availability/0_high_availability'},
        ...
        sidebar: {
            ...
            '/micro_service/': getSidebarFromDir(path.resolve(__dirname, '../micro_service')),
            '/mq/': getSidebarFromDir(path.resolve(__dirname, '../mq')),
            '/high_concurrency/': getSidebarFromDir(path.resolve(__dirname, '../high_concurrency')),
            '/distributed/': getSidebarFromDir(path.resolve(__dirname, '../distributed')),
            '/high_availability/': getSidebarFromDir(path.resolve(__dirname, '../high_availability')),
            ...
            '/cloud_native/': getSidebarFromDir(path.resolve(__dirname, '../cloud_native')),
