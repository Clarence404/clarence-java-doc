...
export default defineUserConfig({
    ...
    theme: defaultTheme({
        ...
        navbar: [  // 顶部导航栏配置
            ...
            {text: '高可用', link: '/high-availability/0_high_availability'},
            {text: '设计模式', link: '/design-patterns/0_design'},
            {text: '场景题', link: '/scenario-solutions/0_scene'},
        ...
        sidebar: {
            ...
            '/high-concurrency/': getSidebarFromDir(path.resolve(__dirname, '../high-concurrency')),
            '/distributed/': getSidebarFromDir(path.resolve(__dirname, '../distributed')),
            '/high-availability/': getSidebarFromDir(path.resolve(__dirname, '../high-availability')),
            '/design-patterns/': getSidebarFromDir(path.resolve(__dirname, '../design-patterns')),
            '/scenario-solutions/': getSidebarFromDir(path.resolve(__dirname, '../scenario-solutions')),
